...
function (_Component) {
  ...
  function Index(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "checkToken", function (access_token) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_3___default.a.get(query).then(function (res) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                this.checkToken(_config__WEBPACK_IMPORTED_MODULE_4__["default"].access_token); // if (!aaaaa) {
...
//# sourceMappingURL=index.js.00bd5b7bff5f161dc2c7.hot-update.js.map